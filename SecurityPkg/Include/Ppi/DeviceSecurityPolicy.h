...
typedef struct _EDKII_DEVICE_SECURITY_POLICY_PPI
    EDKII_DEVICE_SECURITY_POLICY_PPI;

//
// Revision The revision to which the DEVICE_SECURITY_POLICY PPI interface
// adheres.
...
#define EDKII_DEVICE_SECURITY_STATE_ERROR_UEFI_GET_POLICY_PPI                  \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x1)
#define EDKII_DEVICE_SECURITY_STATE_ERROR_UEFI_OUT_OF_RESOURCE                 \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x2)
#define EDKII_DEVICE_SECURITY_STATE_ERROR_DEVICE_NO_CAPABILITIES               \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x10)
#define EDKII_DEVICE_SECURITY_STATE_ERROR_DEVICE_ERROR                         \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x11)
#define EDKII_DEVICE_SECURITY_STATE_ERROR_TCG_EXTEND_TPM_PCR                   \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x20)
#define EDKII_DEVICE_SECURITY_STATE_ERROR_MEASUREMENT_AUTH_FAILURE             \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x21)
#define EDKII_DEVICE_SECURITY_STATE_ERROR_CHALLENGE_FAILURE                    \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x30)
#define EDKII_DEVICE_SECURITY_STATE_ERROR_CERTIFIACTE_FAILURE                  \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x31)
#define EDKII_DEVICE_SECURITY_STATE_ERROR_NO_CERT_PROVISION                    \
  (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x32)
...
/**
  ...
  @param[out] DeviceSecurityPolicy   The Device Security Policy associated with
the device.
...
specific Device.
**/
typedef EFI_STATUS(EFIAPI *EDKII_DEVICE_SECURITY_GET_DEVICE_POLICY)(
...
specific Device.
**/
typedef EFI_STATUS(EFIAPI *EDKII_DEVICE_SECURITY_NOTIFY_DEVICE_STATE)(
    IN EDKII_DEVICE_SECURITY_POLICY_PPI *This,
    IN EDKII_DEVICE_IDENTIFIER *DeviceId,
